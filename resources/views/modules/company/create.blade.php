<div class="modal-dialog modal-lg  modal-dialog-top mt-4">
    <div class="modal-content bg-white">
        ...
        <div class="modal-header bg-dark">
            <h4 class="modal-title text-light">{{ __('New Company') }} </h4>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date"  class="form-control"
                                                            ...
                                                            value="{{ old('date_of_foundation') == null ? date('Y-m-d') : old('date_of_foundation') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="address">{{ __('Address') }} <span
                                                                class="text-danger">*</span></label>
                                                        <textarea class="form-control" rows="1" id="address" name="address" placeholder="{{ __('Enter address') }}">{{ old('adress') }}</textarea>
    ...
    $(document).ready(function() {
        ...
        $("#formCreate").on("submit", function(event) {
           ...
           // toastr.success("huray");
            ...
            var url = "{{ route($role . '.company.store') }}";
